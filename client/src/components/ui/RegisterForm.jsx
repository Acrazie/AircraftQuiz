...
import { IconBrandGoogleFilled, IconUser, IconMail, IconKey, IconEyeOff, IconEye } from "@tabler/icons-react";
		...
		<>
			<div className="w-md">
				<ul className="steps w-full mb-6">
					<li className={`step ${currentStep >= 1 ? "step-primary" : ""}`}>Username</li>
					<li className={`step ${currentStep >= 2 ? "step-primary" : ""}`}>Email</li>
					<li className={`step ${currentStep >= 3 ? "step-primary" : ""}`}>Password</li>
					<li className={`step ${currentStep >= 4 ? "step-primary" : ""}`}>Confirm</li>
				</ul>
			</div>
			<fieldset className="fieldset bg-base-200 border-base-300 w-md rounded-box border p-8">
				...
				{currentStep === 4 && (
					<form onSubmit={handleRegister}>
						<div className="flex flex-col justify-items-center items-center">
							<label className="label text-base-content mb-2">Confirm Password</label>
						...
						{/* <label className="label text-base-content">Confirm Password</label>
						<input
							id="confirm-password"
							name="confirm-password"
							type="password"
